    ...
    return (
        <>
            <ToastContainer
                ...
                theme="light"
            />
            <div class="w-screen py-6 px-10 flex justify-between items-center bg-black text-gray-200">
                <Link href="/" class={`${poppins.className} text-lg font-medium cursor-pointer`}>Stay Hippo</Link>
            </div>
            <div className='bg-gray-900 h-[1px] ' />
            <div>
                <div className='flex flex-col justify-center items-center w-screen h-screen  space-y-5 bg-black text-gray-200'>
                    ...
                    <form className='flex flex-col justify-center items-center space-y-5 '>
                        ...
                        <div onClick={signIn} disabled={!username || !password} type="submit" class="cursor-pointer relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-gray-200 border-2 border-gray-800 rounded-full hover:text-gray-200 group hover:bg-gray-900 w-96 mx-auto">
