    ...
    return (
        <div className="flex flex-col h-screen ">
            ...
            <div className='flex flex-col justify-center items-center w-screen '>
                ...
                <div className="flex flex-col flex-grow justify-center items-center my-10 space-y-10 mx-64 ">
                    <h1 className={`${poppins.className} text-5xl font-bold`}>Terms and Conditions for Luna</h1>
                    <ul className={`${poppins.className} list-disc ml-8`}>
                        <li>
