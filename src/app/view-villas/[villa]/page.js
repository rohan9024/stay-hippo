...
function GroupProps({ params }) {
    ...
    return (
        <>
                        ...
                        <div className="w-full max-w-2xl  rounded-lg  bg-white">
                            <div class="relative  rounded-lg   bg-white ">
                                ...
                                <div className='flex flex-col space-y-5 mb-20  mx-12 my-5 '>
                                    ...
                                    <div type="submit" onClick={() => villaAllocation()} class=" cursor-pointer w-96 relative inline-flex items-center px-12 py-2 overflow-hidden text-lg font-medium  border-2 border-gray-800 rounded-full hover:text-gray-900 group hover:bg-gray-900">
                        ...
                        <div className="w-full max-w-2xl  rounded-lg shadow ">
                            <div class="relative  rounded-lg ">
                                <div class="flex items-start justify-between p-4 border-b border-gray-800  rounded-t ">
                                    ...
                                    <button onClick={() => setDeleteModal(null)} type="button" class=" bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center " data-modal-hide="default-modal">
                                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                        </svg>
                                        <span class="sr-only">Close modal</span>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.7 }} className='px-10 md:px-28 pt-10 h-screen  '>
                <div className={`${poppins.className} flex justify-start items-center space-x-2 pb-10 `}>
                    <img src='/back.png' alt="back" className='w-5 h-5 ' />
                    <Link href="/view-villas" className='text-lg  cursor-pointer hover:ease-in transition  hover:'>Back</Link>
                </div>
                <div className={`${poppins.className} flex justify-between items-center`}>
                    ...
                    <div class="flex justify-center items-center space-x-5">
                        <div className='flex justify-center items-center px-5 py-2  border border-gray-800  rounded-lg  cursor-pointer' onClick={() => setAllocationModal(true)}>
